...
const Appointment = ({event}) => {
  ...
  return (
    <div className="appointmentContent" style={appointmentCardStyle}>
      <div className="appointment-timestamp" style={appointmentContentStyle}>{event&&dayjs(appointmentStartTime).format("HH:mm")+" - "+dayjs(appointmentEndTime).format("HH:mm")}</div>
      <div className="appointment-title" style={appointmentContentStyle}>{appointmentTitle}</div>
    </div>
  );
};
